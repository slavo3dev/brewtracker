------------------------------------------------------------
-- INV-12
-- Warehouse <-> Driver Inventory Transfer Workflow
--
-- Supports:
--
-- warehouse_issue:
...
--   Driver -> Warehouse
--
-- Quantities are normalized using INV-8 packaging metadata.
-- Inventory movements remain immutable INV-9 ledger facts.
------------------------------------------------------------


------------------------------------------------------------
-- RECORD WAREHOUSE / DRIVER TRANSFER
------------------------------------------------------------
